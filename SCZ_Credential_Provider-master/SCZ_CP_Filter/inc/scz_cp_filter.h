...
class SCZ_ProviderFilter : public ICredentialProviderFilter 
{ 
	public: 
	...
	friend HRESULT Provider_CreateInstance(__in REFIID riid, __deref_out void** ppv); 

	protected: 
	SCZ_ProviderFilter(); 
	__override ~SCZ_ProviderFilter(); 
